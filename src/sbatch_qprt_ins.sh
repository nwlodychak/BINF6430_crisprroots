...
# Run CRISPRroots
snakemake \
    -s /courses/BINF6430.202510/students/wlodychak.s/final_project/CRISPRroots-1.3/run.smk \
    --cores ${SLURM_CPUS_PER_TASK} \
    --use-singularity \
    --singularity-args "--bind /courses/BINF6430.202510/students/wlodychak.s/final_project:/courses/BINF6430.202510/students/wlodychak.s/final_project" \
    --latency-wait 60 \
    --rerun-incomplete \
    --keep-going \
    --configfile /courses/BINF6430.202510/students/wlodychak.s/final_project/data/qprt_dataset/config.yaml \
    --restart-times 3
