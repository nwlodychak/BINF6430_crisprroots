...
snakemake -s /courses/BINF6430.202510/students/wlodychak.s/final_project/CRISPRroots-1.3/run.smk \
    ...
    --keep-going \
    --verbose \
    --configfile /courses/BINF6430.202510/students/wlodychak.s/final_project/data/pik3ca_dataset/config.het.yaml

# Deactivate environment
micromamba deactivate
echo "PIK3CA - CRISPRroots pipeline completed" | mail -s "Pipeline Status" wlodychak.s@northeastern.edu
